...
public class BombSpawner : ItemSpawner
{
    ...
    public Transform[] bombSpawnPoints2;
    public Transform[] bombSpawnPoints3;
    public Transform[] bombSpawnPoints4;
    ...
    protected override void Spawn()
    {
        ...
        GameObject bomb = Instantiate(item, spawnPosition, Quaternion.identity);
